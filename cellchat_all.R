...
cellchat <- createCellChat(object = inputData, meta = meta, group.by = 'cell_type')
...
saveRDS(cellchat, paste0('cellchat_res/', cond, '_updated_celltype_updated_cellchat.newrun.rds'))
